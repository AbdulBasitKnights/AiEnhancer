...
public abstract class Sticker {
  ...
  public abstract void setNeonText(int color, BlurMaskFilter.Blur style);

  public abstract void setLetterSpacing(float spacing);

  public abstract void setShadowLayer(float radius,float dx,float dy,int color);

  public abstract void setTextGradient(String[] colors);
