package com.aiface.aging.features.frames.maskable;
...
public class MaskableFrameLayout extends FrameLayout {
    ...
    public void removeMask() {
        // If there's an existing final bitmap mask, recycle it to free up memory
        try {
            ...
            // Set the drawable mask to null
            mDrawableMask = null;
            // Force the view to redraw without the mask
            invalidate();
        } catch (Exception e) {
