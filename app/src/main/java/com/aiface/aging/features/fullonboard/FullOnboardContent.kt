...
object FullOnboardContent {
    ...
    val pages: List<FullOnboardPage> = listOf(
        FullOnboardPage.Compare(
            ...
            beforeImageRes = R.drawable.young_lady,
            afterImageRes = R.drawable.old_lady,
        ),
        FullOnboardPage.Compare(
        ...
        FullOnboardPage.Compare(
            titleRes = R.string.full_onboard_chibbi,
            descriptionRes = R.string.full_onboard_chibbi_desc,
            beforeImageRes = R.drawable.wo_makeup_ob,
            afterImageRes = R.drawable.makeup_ob,
        ),
        FullOnboardPage.Compare(
            titleRes = R.string.full_onboard_outfit,
            descriptionRes = R.string.full_onboard_outfit_desc,
            beforeImageRes = R.drawable.outfit_ob_before,
            afterImageRes = R.drawable.outfit_ob_after,
        ),
