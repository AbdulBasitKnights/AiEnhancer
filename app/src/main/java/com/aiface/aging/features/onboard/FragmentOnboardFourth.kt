...
import com.aiface.aging.databinding.FragmentOnbaordingFourthBinding
...
class FragmentOnboardFourth : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mActivity?.let { activity ->
            FirebaseLogUtils.logEvent("onboarding_4_view", "")
            ...
            binding?.btnNextOnboarding?.setOnClickListener {
                FirebaseLogUtils.logEvent("onboarding_4_next", "")
                nav.goNext()
            }
        }
    }
