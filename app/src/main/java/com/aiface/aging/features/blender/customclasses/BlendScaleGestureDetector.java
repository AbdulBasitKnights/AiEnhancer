 ...
 * using the supplied {@link MotionEvent}s. The {@link OnBlendScaleGestureListener}
 * callback will notify users when a particular gesture event has occurred.
 * This class should only be used with {@link MotionEvent}s reported via touch.
 *
 * To use this class:
 * <ul>
 *  <li>Create an instance of the {@code BlendScaleGestureDetector} for your
 *      {@link View}
 ...
 * </ul>
 */
public class BlendScaleGestureDetector {
    private static final String TAG = "BlendScaleGestureDetector";

    /**
     * The listener for receiving notifications when gestures occur.
     * If you want to listen for all the different gestures then implement
     * this interface. If you only want to listen for a subset it might
     * be easier to extend {@link SimpleOnBlendScaleGestureListener}.
     *
     * An application will receive events in the following order:
     * <ul>
     *  <li>One {@link OnBlendScaleGestureListener#onScaleBegin(BlendScaleGestureDetector)}
     *  <li>Zero or more {@link OnBlendScaleGestureListener#onScale(BlendScaleGestureDetector)}
     *  <li>One {@link OnBlendScaleGestureListener#onScaleEnd(BlendScaleGestureDetector)}
     * </ul>
     */
    public interface OnBlendScaleGestureListener {
        /**
         ...
         *          greater than 0.01.
         */
        public boolean onScale(View view, BlendScaleGestureDetector detector);
         ...
         *          rest of the gesture.
         */
        public boolean onScaleBegin(View view, BlendScaleGestureDetector detector);

        /**
         * Responds to the end of a scale gesture. Reported by existing
         * pointers going up.
         *
         * Once a scale has ended, {@link BlendScaleGestureDetector#getFocusX()}
         * and {@link BlendScaleGestureDetector#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        public void onScaleEnd(View view, BlendScaleGestureDetector detector);
    }

    /**
     * A convenience class to extend when you only want to listen for a subset
     * of scaling-related events. This implements all methods in
     * {@link OnBlendScaleGestureListener} but does nothing.
     * {@link OnBlendScaleGestureListener#onScale(BlendScaleGestureDetector)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link OnBlendScaleGestureListener#onScaleBegin(BlendScaleGestureDetector)} returns
     * {@code true}.
     */
    public static class SimpleOnBlendScaleGestureListener implements OnBlendScaleGestureListener {
    ...
    private final OnBlendScaleGestureListener mListener;
    private boolean mGestureInProgress;

    private MotionEvent mPrevEvent;
    private MotionEvent mCurrEvent;

    private BlendVector2D mCurrSpanVector;
    ...
    public BlendScaleGestureDetector(OnBlendScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new BlendVector2D();
    }
    ...
    public BlendVector2D getCurrentSpanVector() {
