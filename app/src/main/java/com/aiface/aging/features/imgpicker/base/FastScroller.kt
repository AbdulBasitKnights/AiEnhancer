...
import com.aiface.aging.databinding.LayoutScrollerBinding
...
class FastScroller @JvmOverloads constructor(
    ...
    private fun showAnimateHandle() {
        if (binding.viewScroller.visibility == VISIBLE) {
            return
        }
        binding.viewScroller.visibility = VISIBLE
    ...
    private fun hideAnimateHandle() {
        if (binding.viewScroller.visibility == INVISIBLE) {
            return
        }
        ...
        ObjectAnimator.ofFloat(
            ...
            addListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    ...
                    binding.viewScroller.visibility = INVISIBLE
    ...
    private fun showBubble() {
        if (binding.viewBubble.visibility == VISIBLE) {
            return
        }
        binding.viewBubble.visibility = VISIBLE
        ObjectAnimator.ofFloat(
            binding.viewBubble,
            TRANSLATION_X,
    ...
    private fun hideBubble() {
        if (binding.viewBubble.visibility == INVISIBLE) {
            return
        }
        ObjectAnimator.ofFloat(
            binding.viewBubble,
            ...
            addListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    super.onAnimationEnd(animation)
                    binding.viewBubble.visibility = INVISIBLE
