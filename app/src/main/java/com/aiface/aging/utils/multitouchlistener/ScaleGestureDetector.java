...
public class ScaleGestureDetector {
    ...
    public boolean onTouchEvent(View view, MotionEvent event) {
        ...
        if (mInvalidGesture) {
            ...
            // Transform gesture in progress_circle - attempt to handle it
            switch (action) {
                case MotionEvent.ACTION_POINTER_DOWN: {
    ...
    /**
     * Returns {@code true} if a two-finger scale gesture is in progress_circle.
     * @return {@code true} if a scale gesture is in progress_circle, {@code false} otherwise.
     */
     ...
     * If a gesture is in progress_circle, the focal point is directly between
